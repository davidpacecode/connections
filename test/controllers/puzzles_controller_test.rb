...
class PuzzlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create puzzle" do
    assert_difference("Puzzle.count") do
      post puzzles_url, params: { puzzle: { name: @puzzle.name, published_on: @puzzle.published_on, puzzle_number: @puzzle.puzzle_number, submitted_by: @puzzle.submitted_by } }
    end
  ...
  test "should update puzzle" do
    patch puzzle_url(@puzzle), params: { puzzle: { name: @puzzle.name, published_on: @puzzle.published_on, puzzle_number: @puzzle.puzzle_number, submitted_by: @puzzle.submitted_by } }
