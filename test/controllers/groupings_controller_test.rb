...
class GroupingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grouping" do
    assert_difference("Grouping.count") do
      post groupings_url, params: { grouping: { common_thread: @grouping.common_thread, puzzle_id: @grouping.puzzle_id, word_1: @grouping.word_1, word_2: @grouping.word_2, word_3: @grouping.word_3, word_4: @grouping.word_4 } }
    end
  ...
  test "should update grouping" do
    patch grouping_url(@grouping), params: { grouping: { common_thread: @grouping.common_thread, puzzle_id: @grouping.puzzle_id, word_1: @grouping.word_1, word_2: @grouping.word_2, word_3: @grouping.word_3, word_4: @grouping.word_4 } }
