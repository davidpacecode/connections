class PuzzlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @puzzle.save
        ...
        format.json { render json: @puzzle.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @puzzle.update(puzzle_params)
        format.html { redirect_to @puzzle, notice: "Puzzle was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to puzzles_path, notice: "Puzzle was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def puzzle_params
      params.expect(puzzle: [ :puzzle_number, :published_on, :name, :submitted_by ])
    end
end
